    ...
    <>
      <nav className="navbar z-50">
        ...
        flex items-center justify-center"
          ...
          <button className="w-12 h-12 rounded-full bg-grey relative flex items-center justify-center hover:bg-black/10" onClick={changeTheme}>
            <i className={"fi fi-rr-" + (theme == "light" ? "moon-stars" : "sun") + " text-2xl block mt-1 items-center justify-center"}></i>
          </button>
                  ...
                  <button className="w-12 h-12 rounded-full bg-grey relative flex items-center justify-center hover:bg-black/10">
                    ...
                    <i className="fi fi-rr-bell text-2xl black mt-1"></i>
                    {
                      new_notification_available ?
                        <span className="bg-red w-3 h-3 rounded-full absolute z-10 top-1.5 right-1.5"></span> : ""
                    }
